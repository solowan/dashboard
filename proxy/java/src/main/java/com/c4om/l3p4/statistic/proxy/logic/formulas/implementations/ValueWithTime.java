 ...
 */
public class ValueWithTime extends FormulaWithTime {
    private static final Logger LOGGER = LogManager.getLogger(ValueWithTime.class.getName());

    private Object value;

    public ValueWithTime(String id, Boolean publish, Long time,Object value) {
